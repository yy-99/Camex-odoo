...
class MailMessage(models.Model):
    ...
    message_type = fields.Selection(
        selection_add=[('facebook_message', 'Facebook'),('instagram_message', 'Instagram')],
        ondelete={'facebook_message': lambda recs: recs.write({'message_type': 'comment'}),
                  'instagram_message': lambda recs: recs.write({'message_type': 'comment'})},
    )
    facebook_message_ids = fields.One2many('facebook.message', 'mail_message_id', string='Related Facebook Messages')
    instagram_message_ids = fields.One2many('instagram.message', 'mail_message_id', string='Related Instagram Messages')
